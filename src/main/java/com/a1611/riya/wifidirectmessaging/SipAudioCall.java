 ...
 * </div>
 */
public class SipAudioCall extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sipaudiocall);
    }
    ...
    private SimpleSessionDescription createOffer() {
        ...
        SimpleSessionDescription.Media media = offer.newMedia(
    ...
    private SimpleSessionDescription createAnswer(String offerSd) {
        ...
        for (SimpleSessionDescription.Media media : offer.getMedia()) {
            if ((codec == null) && (media.getPort() > 0)
                ...
                if (codec != null) {
                    SimpleSessionDescription.Media reply = answer.newMedia(
                            "audio", mAudioStream.getLocalPort(), 1, "RTP/AVP");
